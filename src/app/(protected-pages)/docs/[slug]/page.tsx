...
interface FrontMatter {
  ...
  [key: string]: any; // Allows for additional, arbitrary properties in front matter
}
...
export async function generateStaticParams(): Promise<Params[]> {
  ...
  try {
    ...
    console.error(`Error reading content directory at ${contentDirectory}:`, error);
  ...
  try {
    ...
    // for non-existent slugs. This acts as a fallback for dynamic scenarios or unexpected issues.
      ...
      return (
        <div className="prose dark:prose-invert max-w-none mx-auto p-8 text-center">
          ...
          <p>The page for "{slug}" could not be found. Please check the URL or if the content file exists.</p>
        </div>
      );
    }
  } catch (error) {
    ...
    return (
      <div className="prose dark:prose-invert max-w-none mx-auto p-8 text-center text-red-500">
        ...
        <p>An error occurred while trying to load the page for "{slug}".</p>
